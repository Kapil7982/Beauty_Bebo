function navbar() {
  return `
   ...
   <div id="third">
       ...
       <div id="third2">
             <select class="cat" name="cat">
               ...
               <option value="131">- - - - - - Bronzer</option>
                <option value="132"><a id="bbcream" href="/BeboBeauty/index.html">- - - - - - BB Cream</a></option>
               <option value="133">
                 - - - - - - Loose Powder
               </option>
               <option value="134">
           ...
           <input oninput="searchprod()" id="search" type="text" placeholder="Search Products..." oninput="debounceFunction(main,1000)">
           <input id="search1" type="submit" value="SEARCH"></div>
       ...
       <div> <a href="/BeboBeauty/login/signup.html"><p>My Account</p></div>
       </a>
       </div>
   ...
   <div id="menu">
     <div id="menu1">
       <ul id="main_menu">
         ...
         <li class="main_list"><b><a id="makeup" href="/BeboBeauty/index.html">MAKEUP</a></b>
         <ul>
         <ol>
         <li>FACE</li>
         <li><a href="/BeboBeauty/index.html">BB Cream</a></li>
         <li>Bronzer</li>
         <li>CC Cream</li>
         <li>Contour</li>
         <li>Concenaler</li>
        ...
        <li>Lip Plumer</li>
         ...
         <li class="main1_list"><b><a id="skin" href="/BeboBeauty/data.html">SKIN</a></b>
           <ul>
           <ol>
           <li>EYE CARE</li>
           <li>Dark Circles</li>
          ...
          <li><img src="https://www.beautybebo.com/pub/media/mega-menu/SKIN_cATA.jpg"></li>
           ...
           <li class="main2_list"><b><a id="hair" href="/BeboBeauty/hair.html">HAIR</a></b>
             <ul>
             <ol>
               <li>HAIR CARE</li>
